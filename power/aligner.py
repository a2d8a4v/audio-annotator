...
class PowerAligner:
    ...
    def __init__(self, ref, hyp, lowercase=False, verbose=False,
        ...
        self.split_regions_before_merge = None
    ...
    def align(self):
        ...
        # print('00>>>>self.error_indexes[0].align: ', self.split_regions[0].align)
        self.phonetic_alignments = [None] * len(self.split_regions)

        collect = {}
        for i, seg in enumerate(self.split_regions):
        ...
        for error_index in self.error_indexes:
            ...
            power_seg_alignment_for_word, power_seg_alignment_for_phone = PowerAligner.phoneAlignToWordAlign(ref_words, hyp_words, 
                ref_phones, hyp_phones)
            self.phonetic_alignments[error_index] = power_seg_alignment_for_phone
            # Replace the error region at the current index.
            self.split_regions[error_index] = power_seg_alignment_for_word
            collect[error_index]['word_align'] = power_seg_alignment_for_word
            collect[error_index]['phone_align'] = power_seg_alignment_for_phone
        ...
        self.split_regions_before_merge = copy.deepcopy(self.split_regions)
